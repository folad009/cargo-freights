...
export declare const UV_FEATURE_FLAG = "enableUvCLI";
...
export type SupportedPackageManagers = 'rubygems' | 'npm' | 'yarn' | 'pnpm' | 'maven' | 'pip' | 'sbt' | 'gradle' | 'golangdep' | 'gomodules' | 'nuget' | 'paket' | 'composer' | 'cocoapods' | 'poetry' | 'hex' | 'Unmanaged (C/C++)' | 'swift' | 'uv';
