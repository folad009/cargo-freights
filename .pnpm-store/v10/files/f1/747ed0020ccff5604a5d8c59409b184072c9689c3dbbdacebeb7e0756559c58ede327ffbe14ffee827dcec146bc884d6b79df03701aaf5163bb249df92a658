import { Contributor, MonitorOptions, Options, PolicyOptions } from '../types';
...
export declare function generateMonitorDependenciesRequest(scanResult: ScanResult, options: Options & MonitorOptions): Promise<MonitorDependenciesRequest>;
