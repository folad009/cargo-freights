...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createPathExclusionMatcher = exports.makeFileAndDirectoryGenerator = exports.computeCustomRulesBundleChecksum = exports.isValidBundle = exports.extractBundle = exports.createIacDir = void 0;
const fs = __webpack_require__(57147);
const tar = __webpack_require__(3479);
...
const mm = __webpack_require__(70850);
const exclude_flag_invalid_input_1 = __webpack_require__(40159);
function hashData(s) {
...
function* makeFileAndDirectoryGenerator(root = '.', maxDepth, isExcluded = () => false) {
    function* generatorHelper(pathToScan, currentDepth) {
        ...
        if (maxDepth !== currentDepth) {
            for (const dirent of (0, fs_1.readdirSync)(pathToScan, { withFileTypes: true })) {
                const fullPath = (0, path_1.join)(pathToScan, dirent.name);
 ...
 */
function createPathExclusionMatcher(rawExcludeFlag) {
...
exports.createPathExclusionMatcher = createPathExclusionMatcher;
