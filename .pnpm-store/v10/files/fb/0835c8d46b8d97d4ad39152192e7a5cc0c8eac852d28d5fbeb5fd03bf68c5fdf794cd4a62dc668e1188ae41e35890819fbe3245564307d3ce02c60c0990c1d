import { type ExclusionMatcher } from './file-utils';
/**
 ...
 */
export declare function getAllDirectoriesForPath(pathToScan: string, maxDepth?: number, isExcluded?: ExclusionMatcher): string[];
/**
 ...
 */
export declare function getFilesForDirectory(pathToScan: string, currentDirectory: string, isExcluded?: ExclusionMatcher): string[];
/**
 ...
 */
export declare function getFilesForDirectoryGenerator(pathToScan: string, isExcluded?: ExclusionMatcher): Generator<string>;
